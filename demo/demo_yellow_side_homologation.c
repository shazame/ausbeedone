...
void demo_yellow_side_homologation_start(struct trajectory_manager *t)
{
  xTaskCreate(demo_yellow_side_homologation_task, (const signed char *)"DemoYellowSideHomologation", 100, (void *)t, 1, NULL );
}
